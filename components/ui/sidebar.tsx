...
import {  MapPinIcon, HomeIcon, BellIcon, HeartIcon, SettingsIcon, LogOutIcon } from 'lucide-react'
...
export default function Sidebar() {
  ...
  return (
    ...
    <div className="absolute bottom-0 w-64 p-4">
      <Button variant="outline" className="w-full flex items-center justify-center" onClick={() => router.push('/login')}>
