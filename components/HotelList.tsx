...
export default function HotelList({ hotels, categories, onEdit }: HotelListProps) {
  ...
  return (
    <div>
      <div className="flex justify-between mb-4">
        ...
        <Select onValueChange={(value) => setSortBy(value as 'name' | 'category')}>
          <SelectTrigger className="w-[180px]">
        ...
        {sortedHotels.map((hotel) => (
          <Card key={hotel.id}>
            ...
            <div className="flex justify-end p-4">
              <Button variant="outline" size="icon" className="mr-2" onClick={() => onEdit(hotel)}>
